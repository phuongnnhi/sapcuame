...
import { getProducts, deleteProduct, updateProduct } from '../../app/apiFunctions';
import {
    Table,
    TableBody,
    TableCell,
...
const ProductList: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <Button variant="contained" color="primary" size="small" onClick={() => navigate(`/admin/products/addproduct`)}>
                                    Thêm sản phẩm mới
                                </Button>
  ...
  />
                            ...
                            <TableCell>
                                <Button variant="contained" color="primary" size="small" onClick={() => navigate(`/products/${product._id}/edit`)}>
                                    Edit
                                </Button>
                                <Button
                                    variant="contained"
